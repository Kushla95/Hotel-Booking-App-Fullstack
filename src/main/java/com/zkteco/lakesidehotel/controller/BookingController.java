...
import com.zkteco.lakesidehotel.exception.ResourceNotFoundException;
...
import com.zkteco.lakesidehotel.service.IBookingService;
...
public class BookingController {
    ...
    public ResponseEntity<?> saveBooking(@PathVariable Long roomId,
            @RequestBody BookedRoom bookingReequest) {
        try {
